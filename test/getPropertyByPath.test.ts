import { getPropertyByPath as getPropertyByPathActual } from '../src/getPropertyByPath';

const getPropertyByPath: typeof getPropertyByPathActual = (...params) =>
  require('../src/getPropertyByPath').getPropertyByPath(...params);
