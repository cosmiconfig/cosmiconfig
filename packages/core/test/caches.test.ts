...
describe('cache is not used initially', () => {
  ...
  test('async', async () => {
    const explorer = cosmiconfigBasic('foo', { searchStrategy: 'global' });
  ...
  test('sync', () => {
    const explorer = cosmiconfigBasicSync('foo', { searchStrategy: 'global' });
...
describe('cache is used for already-visited directories', () => {
  ...
  test('async', async () => {
    const readFileSpy = vi.spyOn(fsPromises, 'readFile');
    const cachedSearch = cosmiconfigBasic('foo', {
  ...
  test('sync', () => {
    const readFileSpy = vi.spyOn(fs, 'readFileSync');
    const cachedSearchSync = cosmiconfigBasicSync('foo', {
      searchStrategy: 'global',
    }).search;
    // First pass, prime the cache ...
...
describe('cache is used for already-loaded file', () => {
  ...
  test('async', async () => {
    const cachedLoad = cosmiconfigBasic('foo').load;
    // First pass, prime the cache ...
  ...
  test('sync', () => {
    const cachedLoadSync = cosmiconfigBasicSync('foo').load;
    // First pass, prime the cache ...
...
describe('cache is not used when directly loading an unvisited file', () => {
  ...
  test('async', async () => {
    const readFileSpy = vi.spyOn(fsPromises, 'readFile');
    const explorer = cosmiconfigBasic('foo');
    // First pass, prime the cache ...
  ...
  test('sync', () => {
    const readFileSpy = vi.spyOn(fs, 'readFileSync');
    const explorer = cosmiconfigBasicSync('foo');
    // First pass, prime the cache ...
...
describe('cache is not used in a new cosmiconfigBasic instance', () => {
  const searchPath = temp.absolutePath('a/b/c/d/e');
  ...
  test('async', async () => {
    // First pass, prime the cache ...
    await cosmiconfigBasic('foo', { searchStrategy: 'global' }).search(
      searchPath,
    );
    // Search again.
    const explorer = cosmiconfigBasic('foo', { searchStrategy: 'global' });
  ...
  test('sync', () => {
    // First pass, prime the cache ...
    cosmiconfigBasicSync('foo', { searchStrategy: 'global' }).search(
      searchPath,
    );
    // Search again.
    const explorer = cosmiconfigBasicSync('foo', { searchStrategy: 'global' });
...
describe('with cache disabled', () => {
  const explorer = cosmiconfigBasic('foo', { cache: false });
...
describe('with cache disabled, does not cache file results', () => {
  ...
  test('sync', () => {
    const readFileSpy = vi.spyOn(fs, 'readFileSync');
    const explorer = cosmiconfigBasicSync('foo', { cache: false });
    explorer.load(loadPath);
    readFileSpy.mockClear();
